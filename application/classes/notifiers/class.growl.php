...
/**
 * modified version of php-growl; http://github.com/tylerhall/php-growl/
 * credit remains with tylerhall
 */
...
class Growl
{
	...
	public function notification($message, $title) {
		return $this->notify("Report found for watcher", "nzbVR - {$title}", $message, 0, false);
	}
