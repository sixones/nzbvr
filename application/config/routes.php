...
$r->add(new PicnicRoute("/movies/delete/(\d.+)", "MoviesController", "delete"));
...
$r->add(new PicnicRoute("/watchers/check/(\d.+)", "WatchersController", "check"));
$r->add(new PicnicRoute("/watchers/update", "WatchersController", "update"));
$r->add(new PicnicRoute("/watchers/update/(\d.+)", "WatchersController", "update"));
